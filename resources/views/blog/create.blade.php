...
<div class="container-xxl py-5">
    <div class="container">
        <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
            <h2 class="section-title bg-white text-center text-primary px-3">Criar Postagem</h2>
        </div>
        <div class="row g-12">
            <div class="col-lg-12 col-md-12 wow fadeInUp" data-wow-delay="0.5s">
                <form id="rec-form" method="POST" action="{{url('blog')}}" enctype="multipart/form-data">
                    @csrf
